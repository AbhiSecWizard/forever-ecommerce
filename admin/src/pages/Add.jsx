  ...
  <div>
    ...
    <div className="flex gap-2">
      <label htmlFor="image1">
           ...
           <input onChange={(e)=>setImage1(e.target.files[0])} className="w-20" type="file" id="image1" hidden/>
      </label>
...
<option value="Winterwear">Winterwear</option>
     ...
     <div>
          ...
          <div className="flex gap-3">
               ...
               <div  onClick={()=>setSizes(prev => prev.includes("XX") ? prev.filter(item=> item !== "XX"):[...prev,'XX'])}>
                    <p className={`${sizes.includes("XX")? "bg-pink-100":'bg-slate-200'} px-3 py-1 cursor-pointer`}>XX</p>
               </div>
          </div>
     </div>
